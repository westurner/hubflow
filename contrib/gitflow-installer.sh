...
EXEC_FILES="git-hf"
SCRIPT_FILES="git-hf-init git-hf-feature git-hf-hotfix git-hf-release git-hf-support git-hf-update git-hf-upgrade git-hf-version hubflow-common gitflow-shFlags"
